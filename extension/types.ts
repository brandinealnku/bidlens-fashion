...
export type ExtractedEbthListing={id:string;sourcePageUrl:string;listingUrl?:string;ebthItemId?:string;title?:string;imageUrl?:string;currentBidCents?:number;priceText?:string;timeRemaining?:string;endingText?:string;auctionEndIso?:string;shippingText?:string;pickupText?:string;categoryText?:string;cardText?:string;boundingBox?:Box;extractionConfidence:number;extractionWarnings:string[]};
